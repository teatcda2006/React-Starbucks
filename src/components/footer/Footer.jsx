  ...
  return (
    <div className="block px-20 mt-10 bg-white">
      <div>
        <ul className="block text-2xl">
          <li className="footer-menu-item">
            <div
              className="flex justify-between w-[100%] py-8"
          ...
          <li className="footer-menu-item">
            ...
            <div
              className={`overflow-hidden transition-all duration-500 transform ${
                openMenu.contactUs ? "max-h-20" : "max-h-0 "
              }`}
            >
              <ul className="text-sm font-bold bg-white">
                <li>
          ...
          <li className="footer-menu-item">
            <div
              className="flex justify-between w-[100%] py-8"
              onClick={() => toggleMenu("socialResponsibility")}
            >
            ...
            <div
              className={`overflow-hidden transition-all duration-500 transform ${
                openMenu.socialResponsibility ? "max-h-20" : "max-h-0"
              }`}
            >
              <ul className="text-sm font-bold bg-white">
                <li>
          ...
          <li className="footer-menu-item">
            <div
              className="flex justify-between w-[100%] py-8"
              onClick={() => toggleMenu("loyaltyProgram")}
            >
            ...
            <div
              className={`overflow-hidden transition-all duration-500 transform ${
                openMenu.loyaltyProgram ? "max-h-20" : "max-h-0"
              }`}
            >
              <ul className="text-sm font-bold bg-white">
                <li>
      ...
      <div className="flex gap-4 py-10">
        ...
        >
          <a
            href="https://youtu.be/dQw4w9WgXcQ?si=bedfC4QFwbnaCIdO"
            className="w-full h-full cursor-default"
          >
